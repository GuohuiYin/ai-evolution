...
| W13 | 检索质量攻坚周（混合检索召回侧 + reranking 精排侧，数据裁决去留）+ M3 验收 | [w13-retrieval-two-stage.md](w13-retrieval-two-stage.md) | 🟡 进行中（#0 设计稿 ADR-0017 已接受；#1 chunk-size 对照完成，维持 800；2026-09-17） |
